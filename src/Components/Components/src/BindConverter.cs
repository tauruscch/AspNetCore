...
namespace Microsoft.AspNetCore.Components
{
    ...
    {
        private delegate string BindFormatter<T>(T value, CultureInfo culture);
        private delegate string BindFormatterWithFormat<T>(T value, CultureInfo culture, string format);
        ...
        public static string FormatValue(bool value, CultureInfo culture = null) => FormatBoolValueCore(value, culture);

        private static string FormatBoolValueCore(bool value, CultureInfo culture)
        {
            return value.ToString(culture ?? CultureInfo.CurrentCulture);
        }

        public static string FormatValue(bool? value, CultureInfo culture = null) => FormatNullableBoolValueCore(value, culture);

        private static string FormatNullableBoolValueCore(bool? value, CultureInfo culture)
        {
            if (value == null)
            {
                return null;
        ...
        public static string FormatValue(float? value, string format = null, CultureInfo culture = null) => FormatNullableFloatValueCore(value, culture);
        ...
        public static string FormatValue(DateTime value, string format = null, CultureInfo culture = null) => FormatDateTimeValueCore(value, format, culture);
        ...
        public static string FormatValue(DateTime? value, string format = null, CultureInfo culture = null) => FormatNullableDateTimeValueCore(value, format, culture);
        ...
        public static string FormatValue(DateTimeOffset value, string format = null, CultureInfo culture = null) => FormatDateTimeOffsetValueCore(value, format, culture);
        ...
        public static string FormatValue(DateTimeOffset? value, string format = null, CultureInfo culture = null) => FormatNullableDateTimeOffsetValueCore(value, format, culture);
        ...
        private static string FormatEnumValueCore<T>(T value, string format, CultureInfo culture) where T : struct, Enum
        {
            return value.ToString(format); // The overload that acccepts a culture is [Obsolete]
        }
        ...
        public static bool TryConvertFloat(object obj, CultureInfo culture, out float value)
        {
